...
class SPYR_MPESA_G2 extends WC_Payment_Gateway {
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'paybill_no' => array(
				'title'		=> __( 'Mpesa Paybill Number', 'spyr-mpesa-G2' ),
				'type'		=> 'text',
				'default'	=> 898998,
				'desc_tip'	=> __( 'This is your paybill number as provided by Safaricom.', 'spyr-mpesa-G2' ),
			),
			'callback_url' => array(
			...
			'pass_key' => array(
				'title'		=> __( 'Mpesa Pass Key', 'spyr-mpesa-G2' ),
				'type'		=> 'password',
				'desc_tip'	=> __( 'SAG Passkey generated by Safaricom on registration of the Merchant\'s Paybill Number', 'spyr-mpesa-G2' ),
			),
			'environment' => array(
